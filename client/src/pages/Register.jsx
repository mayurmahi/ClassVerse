...
const Register = () => {
  ...
  const steps = [
    ...
    { icon: "🚀", title: "Start Learning", desc: "Connect and grow with OptimalPadho" },
  ];
        ...
        <div className="relative z-10 flex flex-col h-full px-14 py-12">
          ...
          <div className="mt-auto mb-16">
            ...
            <motion.p className="text-white/40 text-base leading-relaxed max-w-sm mb-10"
              ...
              Join thousands of students and teachers already using OptimalPadho.
            </motion.p>
      ...
      <div className="flex-1 lg:flex-none lg:w-[520px] flex items-center justify-center bg-[#f8fafc] px-8 py-10 relative overflow-y-auto">
        ...
        <motion.div className="w-full max-w-sm relative z-10 py-4"
          ...
          <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.2 }}>
            ...
            <p className="text-[#5a7a96] text-sm">Fill in your details to join OptimalPadho for free</p>
          </motion.div>
