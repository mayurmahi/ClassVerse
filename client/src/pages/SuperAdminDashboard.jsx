  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="p-6">
        ...
        {/* Users Tab - Drodown Filter Added Here */}
        {activeTab === "users" && (
          <div className="bg-white rounded-xl border overflow-hidden shadow-sm">
            <div className="px-5 py-4 border-b flex flex-col md:flex-row justify-between items-start md:items-center gap-3">
              <h2 className="font-bold text-[#1F4E79]">All Users</h2>
              
              {/* DROPDOWN FILTER */}
              <div className="flex items-center gap-2">
                <label className="text-xs font-medium text-gray-500">View By Organization:</label>
                <select 
                  className="border rounded-lg px-3 py-1.5 text-sm focus:ring-2 focus:ring-[#1F4E79] outline-none bg-gray-50"
                  value={selectedOrgId}
